...
$request_id     = $_GET['id'];
    ...
    if (isset($_POST['cmdUpdate'])) {
        ...
        if ($valid == true) {
            # code...
            $query  = " UPDATE `request_type` SET `request` = '".$request."' WHERE `request_id` = '".$request_id."' ";
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Edit Request Type
                            </li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <tbody>
                                            <tr>
                                                ...
                                                $query      = "SELECT `request` FROM `request_type` WHERE `request_id` = '".$request_id."' " ;
