...
$Message = '';
    ...
    if (isset($_POST['cmdAdd'])) {
        ...
        if ($valid == true) {
            # code...
            $query  = "INSERT INTO `request_type` SET `request` = '".$request."' ";
            ...
            $query = "    INSERT INTO `log_trail` SET 
                    `TS`        = '".$cur_timestamp."', 
                    `user_id`   = '".$user_id."', 
                    `action`    = '[ ".$FN." ] Added a new request type at page [".$page."]'  
            ";
            mysql_query($query) or die(mysql_error());
            ...
            <div class="alert alert-info">
               <i class="fa fa-ticket"></i> New Request Type <strong>[ '.$request.' ]</strong> 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-ticket"></i> <a href="admin-request-list.php">Request Type List</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-edit"></i> Add Request Type
                            </li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class='col-sm-8 col-xm-8'>
                                                    ...
                                                    placeholder='Please Enter Request type here...' value='' >
                                                </td>
                                            </tr>
